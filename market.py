...
def fetch_top_market(count: int = 100, start: int = 0, sort_column: str = "popular", sort_dir: str = "desc") -> Dict:
    """
...
def search_market(query: str, appid: int = None, count: int = 100, start: int = 0) -> Dict:
    """
...
def fetch_item_listings(appid: int, market_hash_name: str, currency: int = 1, start: int = 0, count: int = 10) -> Dict:
    """
...
def fetch_market_recent_activity(appid: int = None, count: int = 10) -> Dict:
    """
